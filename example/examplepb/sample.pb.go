...
func (x *TransferState) GetFailureReason() string {
	if x != nil {
...
// TransferStarted is the event recorded when a transfer begins.
...
// StartTransfer asks a transfer entity to move funds between two accounts.
...
func (x *StartTransfer) GetSourceAccountId() string {
	if x != nil {
		return x.SourceAccountId
	}
	return ""
...
func (x *StartTransfer) GetDestinationAccountId() string {
	if x != nil {
		return x.DestinationAccountId
	}
	return ""
...
func (x *StartTransfer) GetAmount() float64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
// TransferFailed is a saga event recorded when a transfer step is rejected.
...
const file_sample_sample_proto_rawDesc = "" +
	...
	"\n" +
	"account_id\x18\x01 \x01(\tR\taccountId\x12'\n" +
	"\x0faccount_balance\x18\x02 \x01(\x01R\x0eaccountBalance\"\xab\x02\n" +
	...
	"\x14destination_credited\x18\x06 \x01(\bR\x13destinationCredited\x12%\n" +
	"\x0efailure_reason\x18\a \x01(\tR\rfailureReason\"\xac\x01\n" +
	...
	"\x06amount\x18\x02 \x01(\x01R\x06amount\"\xaa\x01\n" +
	"\rStartTransfer\x12\x1f\n" +
	"\vtransfer_id\x18\x01 \x01(\tR\n" +
	"transferId\x12*\n" +
	"\x11source_account_id\x18\x02 \x01(\tR\x0fsourceAccountId\x124\n" +
	"\x16destination_account_id\x18\x03 \x01(\tR\x14destinationAccountId\x12\x16\n" +
	"\x06amount\x18\x04 \x01(\x01R\x06amount\"I\n" +
	"\x0eTransferFailed\x12\x1f\n" +
	"\vtransfer_id\x18\x01 \x01(\tR\n" +
	"transferId\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reasonB\x9a\x01\n" +
...
var file_sample_sample_proto_goTypes = []any{
	...
	(*StartTransfer)(nil),       // 13: samplepb.StartTransfer
	(*TransferFailed)(nil),      // 14: samplepb.TransferFailed
}
