...
//func (a *AccountBehavior) HandleCommand(_ context.Context, command eventsourcing.Command, _ *samplepb.Account) (event eventsourcing.Event, err error) {
...
//func (a *AccountBehavior) HandleEvent(_ context.Context, event eventsourcing.Event, priorState *samplepb.Account) (state *samplepb.Account, err error) {
