...
require (
	...
	github.com/tochemey/goakt v0.2.1
	github.com/tochemey/gopack v0.0.0-20230625183519-1714ac09b9c5
...
require (
	...
	k8s.io/api v0.28.0-alpha.2 // indirect
	k8s.io/apimachinery v0.28.0-alpha.2 // indirect
