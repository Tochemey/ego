...
require (
	...
	github.com/tochemey/goakt v0.8.1
...
require (
	...
	k8s.io/api v0.29.0-alpha.1 // indirect
	k8s.io/apimachinery v0.29.0-alpha.1 // indirect
	k8s.io/client-go v0.29.0-alpha.1 // indirect
